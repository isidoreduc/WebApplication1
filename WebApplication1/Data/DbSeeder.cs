...
namespace WebApplication1.Data
{
    public static class DbSeeder
    {
        ...
        {
            // local variables
            DateTime createdDate = new DateTime(2018, 12, 03, 12, 30, 00);
            ...
            var user_Admin = new ApplicationUser()
            {
                ...
                UserName = "Admin",
                Email = "admin@quizmakerfree.com",
                CreatedDate = createdDate,
                LastModifiedDate = lastModifiedDate
            };
            // Insert the Admin user into the Database
            dbContext.Users.Add(user_Admin);
#if DEBUG //C# pre-processor directive - code in this region executes only when we compile in debug mode (not in production)
            // Create some sample registered user accounts (if they don't exist already)
            var user_Ryan = new ApplicationUser()
            {
                Id = Guid.NewGuid().ToString(),
                UserName = "Ryan",
                Email = "ryan@quizmakerfree.com",
                CreatedDate = createdDate,
                LastModifiedDate = lastModifiedDate
            };
            var user_Solice = new ApplicationUser()
            {
                Id = Guid.NewGuid().ToString(),
                UserName = "Solice",
                Email = "solice@quizmakerfree.com",
                CreatedDate = createdDate,
                LastModifiedDate = lastModifiedDate
            };
